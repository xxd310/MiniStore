 ...
 */
public class OutStorageListItem implements Serializable {
    ...
    public OutStorageListItem() {
    }

    public OutStorageListItem(String product_num, String product_name, String number, String category_id, String local_num, String local_name, String out_number) {
